...
/**
 * PHPExcel_Shared_TrendClass
 *
 * @category   PHPExcel
 * @package    PHPExcel_Shared_Trend
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_Shared_TrendClass
{
		...
		switch ($trendType) {
			...
			case self::TREND_POLYNOMIAL_6	:
				if (!isset(self::$_trendCache[$key])) {
					...
					self::$_trendCache[$key] = new PHPExcel_Shared_Polynomial_Best_Fit($order,$yValues,$xValues,$const);
				}
				return self::$_trendCache[$key];
				break;
			...
			case self::TREND_BEST_FIT_NO_POLY	:
				...
				if ($trendType != self::TREND_BEST_FIT_NO_POLY) {
					foreach(self::$_trendTypePolyOrders as $trendMethod) {
						...
						$bestFit[$trendMethod] = new PHPExcel_Shared_Polynomial_Best_Fit($order,$yValues,$xValues,$const);
