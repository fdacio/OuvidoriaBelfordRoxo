...
class PHPExcel_Calculation_DateTime {
	...
	public static function _getDateValue($dateValue) {
		if (!is_numeric($dateValue)) {
			...
			if ((is_object($dateValue)) && ($dateValue instanceof PHPExcel_Calculation_DateTime)) {
	...
	public static function DATETIMENOW() {
		...
		switch (PHPExcel_Calculation_Functions::getReturnDateType()) {
			...
			case PHPExcel_Calculation_Functions::RETURNDATE_PHP_OBJECT :
					$retValue = new PHPExcel_Calculation_DateTime();
					break;
		}
	...
	public static function TIME($hour = 0, $minute = 0, $second = 0) {
		...
		switch (PHPExcel_Calculation_Functions::getReturnDateType()) {
			...
			case PHPExcel_Calculation_Functions::RETURNDATE_PHP_OBJECT :
					...
					$phpDateObject = new PHPExcel_Calculation_DateTime('1900-01-01 '.$hour.':'.$minute.':'.$second);
					if ($dayAdjust != 0) {
		...
		if (($PHPDateArray !== False) && ($PHPDateArray['error_count'] == 0)) {
			...
			switch (PHPExcel_Calculation_Functions::getReturnDateType()) {
				...
				case PHPExcel_Calculation_Functions::RETURNDATE_PHP_NUMERIC :
						return (integer) PHPExcel_Shared_Date::ExcelToPHP($excelDateValue);
				case PHPExcel_Calculation_Functions::RETURNDATE_PHP_OBJECT :
						return new PHPExcel_Calculation_DateTime($PHPDateArray['year'].'-'.$PHPDateArray['month'].'-'.$PHPDateArray['day'].' 00:00:00');
			}
		}
		return PHPExcel_Calculation_Functions::VALUE();
	}	//	function DATEVALUE()
	...
	public static function TIMEVALUE($timeValue) {
		...
		if (($PHPDateArray !== False) && ($PHPDateArray['error_count'] == 0)) {
			...
			switch (PHPExcel_Calculation_Functions::getReturnDateType()) {
				...
				case PHPExcel_Calculation_Functions::RETURNDATE_PHP_OBJECT :
						return new PHPExcel_Calculation_DateTime('1900-01-01 '.$PHPDateArray['hour'].':'.$PHPDateArray['minute'].':'.$PHPDateArray['second']);
			}
		}
		return PHPExcel_Calculation_Functions::VALUE();
	}	//	function TIMEVALUE()
