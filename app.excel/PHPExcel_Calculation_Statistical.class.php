...
class PHPExcel_Calculation_Statistical {
	 ...
	 * @param p require p>0
	 * @param q require q>0
	 * @return int 0 if p<=0, q<=0 or p+q>2.55E305 to avoid errors and over/underflow
	 */
	 ...
	 * @param p require p>0
	 * @param q require q>0
	 * @return int 0 if x<0, p<=0, q<=0 or p+q>2.55E305 and 1 if x>1 to avoid errors and over/underflow
	 */
	...
	public static function CORREL($yValues,$xValues=null) {
		...
		$bestFitLinear = PHPExcel_Shared_TrendClass::calculate(PHPExcel_Shared_TrendClass::TREND_LINEAR,$yValues,$xValues);
...
//			$CumPGuessMinus1 = $CumPGuess - $PGuess;
	...
	public static function GROWTH($yValues,$xValues=array(),$newValues=array(),$const=True) {
		...
		$bestFitExponential = PHPExcel_Shared_TrendClass::calculate(PHPExcel_Shared_TrendClass::TREND_EXPONENTIAL,$yValues,$xValues,$const);
		if (empty($newValues)) {
	...
	public static function LINEST($yValues, $xValues = NULL, $const = TRUE, $stats = FALSE) {
		...
		$bestFitLinear = PHPExcel_Shared_TrendClass::calculate(PHPExcel_Shared_TrendClass::TREND_LINEAR,$yValues,$xValues,$const);
		if ($stats) {
