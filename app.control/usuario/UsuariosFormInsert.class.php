 ...
 */
class UsuariosFormInsert extends TFormData
{
	...
	*/
	private $INPUTS_FORM = array("USU_ID"=>array("Código","80","false","TEntry",""), 
								 ...
								 "USU_MATRICULA"=>array("Matrícula","350","true","TEntry",""),
								 "USU_EMAIL"=>array("e-Mail","350","true","TEntry",""),
								 "USU_SENHA"=>array("Senha","350","true","TPassword",""),
	...
	*/							  
    ...
    function __construct()
    {
        ...
        $this->INPUTS_FORM['USU_ATIVO'][4] = array("1"=>"Ativo");
