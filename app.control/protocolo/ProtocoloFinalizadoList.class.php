<?php
class ProtocoloFinalizadoList extends TPage{
	...
	private $classForm = "ViewProtocoloForm";//Classe que representa o formulário de Alteração dados;
	...
	*/
	private $FIELDS_GRID_LENGTH = array("10%","15%","25%","20%","15%","15%");
	...
	*/
    ...
    public function __construct(){
		...
		$label1->add('Protocolos Finalizados');
		...
		$action1 = new TDataGridActionExtra(array($formFinalizar, 'onVisualizar'));
	...
	function onReload($url=NULL){
		...
		$criteria->add(new TFilter('PRO.PRO_STATUS','=','3'));
		...
		$critPaginator->add(new TFilter('PRO_STATUS','=','3'));
		if(isset($filter)){
