...
final class TConnection
{
    ...
    public static function open()
    {
        ...
        if (file_exists("app.config/connect.ini"))
        {
            // lê o INI e retorna um array
            $db = parse_ini_file("app.config/connect.ini");
        }
        
        else if(file_exists("../app.config/connect.ini"))
        {
            // lê o INI e retorna um array
            $db = parse_ini_file("../app.config/connect.ini");
        }
		...
		else
        {
            ...
            throw new Exception("Arquivo connect.ini não encontrado");
        }
